...
from .services import search_books_google_api
...
def search_books(request):
    ...
    if query:
        google_response = search_books_google_api(query, page, api_books)
        pagination = google_response.get('pagination')
        api_books = google_response.get('api_books')
    else:
        pagination = None
